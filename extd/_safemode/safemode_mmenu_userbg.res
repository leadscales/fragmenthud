                        ...
                        "UserBG"
                        {
                            ...
                            "ButtonContainer"
                            {
                                ...
                                "Even"
                                {
                                    ...
                                    "tall"                      "19"
                                    "proportionaltoparent"      "1"
                                    "labelText"                 "#FRAG_Safemode_MMenu_UserBG_Even"
                                    "textAlignment"             "center"
                                    "font"                      "FontMedium_12_Additive"
                                    "fgcolor"                   "FragPrimary100"
                                    "defaultbgcolor_override"   "FragPanelTransparentDark40"
                                    ...
                                    "defaultfgcolor_override"   "FragNeutral100"
                                    "armedfgcolor_override"     "FragPrimary100"
                                    "command"                   "engine frag_mmenu_userbg=even"
                                    "actionsignallevel"         "8"
                                    "sound_depressed"           "UI/buttonclick.wav"
                                    "sound_released"            "UI/buttonclickrelease.wav"
                                }
                                ...
                                "Help"
                                {
                                    ...
                                    "armedfgcolor_override"     "FragPrimary100"
                                    "command"                   "url https://github.com/leadscales/fragmenthud/wiki/User-Backgrounds"
                                    "actionsignallevel"         "8"
                                    "sound_depressed"           "UI/buttonclick.wav"
                                    "sound_released"            "UI/buttonclickrelease.wav"
                                }
